...
Deno.serve(async (req: Request) => {
  ...
  let body: { message?: unknown; action?: unknown; draft_id?: unknown; attachments?: unknown; draft_patch?: unknown }; try { body = await req.json(); } catch { return json({ error: { code: "invalid_json", message: "صيغة الطلب غير صالحة." } }, 400); }
